...
class openldap (
  ...
  $modules            = [],
  $service_name       = 'slapd',
  $ldapcluster        = hiera_hash('openldap::ldapcluster_hash',{}),
  $ldapcluster_member = hiera_hash('openldap::ldapcluster_member_hash',{}),
  $ldapcluster_srv    = hiera_hash('openldap::ldapcluster_srv_hash',{}),
)
{
